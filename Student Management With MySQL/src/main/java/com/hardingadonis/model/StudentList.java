package com.hardingadonis.model;

import com.hardingadonis.dao.StudentDAO;
import java.util.*;
import com.hardingadonis.model.comparator.StudentComparatorByID;
import com.hardingadonis.utils.Validation;
...
public class StudentList {
    ...
    public StudentList() {
        this.list = StudentDAO.selectAll();
    }
    ...
    public void addNewStudent() {
        ...
        StudentDAO.insert(new Student(newID, newName, newOld, newGPA));
    }
